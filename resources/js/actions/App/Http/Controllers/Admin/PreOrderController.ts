...
/**
* @see \App\Http\Controllers\Admin\PreOrderController::addPayment
* @see app/Http/Controllers/Admin/PreOrderController.php:173
* @route '/admin/pre-orders/{pre_order}/payments'
*/
export const addPayment = (args: { pre_order: string | { id: string } } | [pre_order: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/pre-orders/{pre_order}/payments'
*/
addPayment.url = (args: { pre_order: string | { id: string } } | [pre_order: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { pre_order: args }
    }
...
* @route '/admin/pre-orders/{pre_order}/payments'
*/
addPayment.post = (args: { pre_order: string | { id: string } } | [pre_order: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addPayment.url(args, options),
    method: 'post',
})
...
* @route '/admin/pre-orders/{pre_order}/payments'
*/
const addPaymentForm = (args: { pre_order: string | { id: string } } | [pre_order: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/pre-orders/{pre_order}/payments'
*/
addPaymentForm.post = (args: { pre_order: string | { id: string } } | [pre_order: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: addPayment.url(args, options),
    method: 'post',
})
...
/**
* @see \App\Http\Controllers\Admin\PreOrderController::deletePayment
* @see app/Http/Controllers/Admin/PreOrderController.php:194
* @route '/admin/pre-orders/{pre_order}/payments/{payment}'
*/
export const deletePayment = (args: { pre_order: string | { id: string }, payment: string | number } | [pre_order: string | { id: string }, payment: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/admin/pre-orders/{pre_order}/payments/{payment}'
*/
deletePayment.url = (args: { pre_order: string | { id: string }, payment: string | number } | [pre_order: string | { id: string }, payment: string | number ], options?: RouteQueryOptions) => {
...
* @route '/admin/pre-orders/{pre_order}/payments/{payment}'
*/
deletePayment.delete = (args: { pre_order: string | { id: string }, payment: string | number } | [pre_order: string | { id: string }, payment: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: deletePayment.url(args, options),
    method: 'delete',
})
...
* @route '/admin/pre-orders/{pre_order}/payments/{payment}'
*/
const deletePaymentForm = (args: { pre_order: string | { id: string }, payment: string | number } | [pre_order: string | { id: string }, payment: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/pre-orders/{pre_order}/payments/{payment}'
*/
deletePaymentForm.delete = (args: { pre_order: string | { id: string }, payment: string | number } | [pre_order: string | { id: string }, payment: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: deletePayment.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const PreOrderController = { index, create, store, show, edit, update, destroy, addPayment, deletePayment }
