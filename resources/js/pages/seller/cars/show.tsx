...
export default function SellerCarShow({ car }: { car: CarDetail }) {
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button variant="outline" size="sm" asChild>
                            <Link href={seller.cars.edit(car.id)}>
                                            ...
                                            <tr key={order.id} className="border-b last:border-0 hover:bg-muted/50">
                                                ...
                                                <td className="px-4 py-3">
                                                    <Button variant="ghost" size="sm" asChild>
                                                        <Link href={seller.orders.show(order.id)}>View</Link>
                                                    </Button>
                                                </td>
                                            </tr>
                                        ))}
                                            ...
                                            return (
                                                <tr key={po.id} className="border-b last:border-0 hover:bg-muted/50">
                                                     <td className="px-4 py-3 font-medium">
                                                         <Link href={seller.preOrders.show(po.id)} className="text-primary hover:underline">
                                                             {po.customer_name}
                                                         </Link>
                                                         {po.customer && (
