...
class BannerController extends ApiController
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'type' => 'required|string|in:slider,banner,boxTrips,boxone,boxLeft,boxRight,boxTen,boxonebuttom',
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'badge_text' => 'nullable|string|max:255',
            'brand_slug' => 'nullable|string|max:100',
            'type' => 'sometimes|string|in:slider,banner,boxTrips,boxone,boxLeft,boxRight,boxTen,boxonebuttom',
            'page' => 'nullable|string|max:100',
            'sort_order' => 'nullable|integer|min:0',
            'is_active' => 'boolean',
        ]);
